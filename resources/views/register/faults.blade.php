    ...
    <div class="row" id="page-content-wrapper">
        <div class="col-lg-11 col-md-offset-2">
            ...
            <div class="container-fluid">
                <h2 class="color1 text-center">Registro de Averias</h2>
                ...
                <form action="{{route('register.fault.store')}}" method="POST" id="fault">
                    ...
                    <div class="form-group">
                        <div class="col-lg-6">
                            <label for="date1">Fecha inicial de la averia</label>
                    ...
                    <div class="form-group">
                        <div class="col-lg-6">
                            <label for="time1">Hora inicial de la averia</label>
                    ...
                    <div class="col-lg-12">
                    <button type="submit" form="fault" value="Registrar" class="btn btn-danger btn-lg"> Registrar <span class="ion-ios-plus-outline"></span></button>
                    </div>
                </form>
